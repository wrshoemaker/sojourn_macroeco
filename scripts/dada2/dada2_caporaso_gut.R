...
path <- "/Users/williamrshoemaker/GitHub/coarse_grained_reproducibility/data/barcode_data/caporaso_et_al/fastq_gut"
...
out <- filterAndTrim(fn, filt, truncLen=120, minLen=100,
...
write.table(t(seqtab.nochim), "/Users/williamrshoemaker/GitHub/coarse_grained_reproducibility/data/barcode_data/caporaso_et_al/seqtab-nochim-gut.txt", sep="\t", row.names=TRUE, col.names=TRUE, quote=FALSE)
# export taxonomy
write.table(taxa, "/Users/williamrshoemaker/GitHub/coarse_grained_reproducibility/data/barcode_data/caporaso_et_al/seqtab-nochim-taxa-gut.txt", sep="\t", row.names=TRUE, col.names=TRUE, quote=FALSE)
